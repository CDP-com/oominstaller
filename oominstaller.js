//
// oominstaller.js
// Summary : template-oominstaller.js used to generate oominstaller.js.
// Icon : oominstaller.jpg
//

var ManVer = "1438268242674";
function GetManVer()
{
    return ManVer;
...
var strFileURL = "http://snapback-apps.com/oominstaller/oominstaller1438268242674.cdpupdate";
...
var strOnlineURL = "http://snapback-apps.com/oominstaller/invis.gif";
...
var SyncCookieName = "oominstallerpckgid";
...
var ManifestFile = "oominstaller.xml"
...
var ManifestURL_Remote = "http://snapback-apps.com/oominstaller/oominstaller.xml";
...
var ManifestURL_Local = "%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\oominstaller\\oominstaller.xml";
...
var StartUrl_Remote = "http://snapback-apps.com/oominstaller/index.html";
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\oominstaller\\startmom.vbs") + "\"" );
    }
